import { defineIntegration, fill, LRUMap, startInactiveSpan, SentryNonRecordingSpan, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, getTraceData, debug, setHttpStatus, stringMatchesSomePattern, getBreadcrumbLogLevelFromHttpStatusCode, addBreadcrumb } from '@sentry/core';
...
const electronNetIntegration = defineIntegration((options = {}) => {
    return {
        ...
        setup(client) {
            ...
            fill(net, 'request', createWrappedRequestFactory(options, enableLogs, clientOptions?.tracePropagationTargets));
        },
    };
});

export { electronNetIntegration };//# sourceMappingURL=http://go/sourcemap/sourcemaps/4ca9b38c6c97d4243bf0c61e51426667cb964bd0/node_modules/@sentry/electron/esm/main/integrations/net-breadcrumbs.js.map
