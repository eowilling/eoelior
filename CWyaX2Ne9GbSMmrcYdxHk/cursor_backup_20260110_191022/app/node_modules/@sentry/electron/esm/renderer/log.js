import { getClient, _INTERNAL_captureLog, getCurrentScope } from '@sentry/core';
export { fmt } from '@sentry/core';
import { getIPC } from './ipc.js';

function captureLog(level, message, attributes, severityNumber) {
    const client = getClient();
    _INTERNAL_captureLog({ level, message, attributes, severityNumber }, getCurrentScope(), (_, log) => getIPC(client).sendStructuredLog(log));
}
/**
...
export { debug, error, fatal, info, trace, warn };//# sourceMappingURL=http://go/sourcemap/sourcemaps/4ca9b38c6c97d4243bf0c61e51426667cb964bd0/node_modules/@sentry/electron/esm/renderer/log.js.map
