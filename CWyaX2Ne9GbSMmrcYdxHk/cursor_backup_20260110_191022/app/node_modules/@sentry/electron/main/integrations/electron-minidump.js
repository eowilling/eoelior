...
function minidumpUrlFromDsn(dsn) {
    const dsnComponents = core.makeDsn(dsn);
    if (!dsnComponents) {
        return undefined;
    }
...
const electronMinidumpIntegration = core.defineIntegration(() => {
    ...
    async function getNativeUploaderEvent(client, scope) {
        ...
        const event = merge.mergeEvents(await context.getEventDefaults(client), {
            sdk: context.getSdkInfo(sendDefaultPii),
            event_id: core.uuid4(),
            level: 'fatal',
            platform: 'native',
    ...
    function startCrashReporter(options) {
        ...
        if (!submitURL) {
            core.debug.log('Invalid DSN. Cannot start Electron crashReporter');
            return;
        }
...
exports.minidumpUrlFromDsn = minidumpUrlFromDsn;//# sourceMappingURL=http://go/sourcemap/sourcemaps/4ca9b38c6c97d4243bf0c61e51426667cb964bd0/node_modules/@sentry/electron/main/integrations/electron-minidump.js.map
