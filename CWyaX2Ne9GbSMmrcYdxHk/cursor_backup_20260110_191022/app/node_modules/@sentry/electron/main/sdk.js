...
function getDefaultIntegrations(options) {
    const integrations = [
        ...
        rendererAnr.rendererEventLoopBlockIntegration(),
...
function init(userOptions) {
    ...
    const optionsWithDefaults = {
        _metadata: { sdk: context.getSdkInfo(!!userOptions.sendDefaultPii) },
    ...
    client.on('beforeCaptureLog', (log$1) => {
        log$1.attributes = {
            ...log$1.attributes,
            'electron.process': 'browser',
            ...log.getOsDeviceLogAttributes(client),
        };
    });
...
exports.init = init;//# sourceMappingURL=http://go/sourcemap/sourcemaps/4ca9b38c6c97d4243bf0c61e51426667cb964bd0/node_modules/@sentry/electron/main/sdk.js.map
