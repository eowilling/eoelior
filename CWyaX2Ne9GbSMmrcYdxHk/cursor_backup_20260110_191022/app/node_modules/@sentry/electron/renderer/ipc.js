...
function getImplementation(ipcKey) {
    const ipcUtil = ipc.ipcChannelUtils(ipcKey);
    ...
    if (window.__SENTRY_IPC__?.[ipcUtil.namespace]) {
        ...
        core.debug.log('IPC was not configured in preload script, falling back to custom protocol and fetch');
        ...
        const id = (window.__SENTRY_RENDERER_ID__ = core.uuid4());
 ...
 */
function getIPC(client = core.getClient()) {
    if (!client) {
...
exports.getIPC = getIPC;//# sourceMappingURL=http://go/sourcemap/sourcemaps/4ca9b38c6c97d4243bf0c61e51426667cb964bd0/node_modules/@sentry/electron/renderer/ipc.js.map
