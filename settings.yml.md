...
server:
  base_url: "https://eosear.zeabur.app/"
  secret_key: "openclaw_secret_key" # 這是供系統使用的隨機字串，保持這樣即可
  image_proxy: true # 順便開啟圖片代理，避免外部圖片破圖
...
server:
  ...
  secret_key: "uqSJSVNxt7U54pncwVeEpOtKXskNLgXB"  # Is overwritten by ${SEARXNG_SECRET}
